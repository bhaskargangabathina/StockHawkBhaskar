package com.bhaskar.android.stockhawk.data;
...
/**
 * Created by bhaskar on 10/5/15.
 */
@ContentProvider(authority = QuoteProvider.AUTHORITY, database = QuoteDatabase.class)
public class QuoteProvider {
  public static final String AUTHORITY = "com.bhaskar.android.stockhawk.data.QuoteProvider";
